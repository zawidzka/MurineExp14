...
# set workingDir
workingDir <- "210326_WorkingDirectory"
...
plotDR(sce, dr = "UMAP", color_by = c("TCF1", "PD1", "TIM3", "EOMES", "TOX", "Tbet", "CD69", 
                                        "Ly108", "CD127", "KLRG1", "CD44", "CD62L", "CXCR3", "CX3CR1"), 
...
ggsave("UMAP_wContours_bymarker.pdf", height = 4, width = 20, plot = last_plot())
